...
(function () {
    CKEDITOR.dialog.add("link", function (g) {
        var n = CKEDITOR.plugins.link, p = function () {
                ...
                if (b && a)switch (b = b.getElement(), b.hide(), a.setValue(""), m) {
                    case "frame":
            ...
            title: b.title, minWidth: 350, minHeight: 230, contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    ...
                    type: "vbox", id: "anchorOptions", width: 260, align: "center", padding: 0, children: [{
                        type: "fieldset", id: "selectAnchorText", label: b.selectAnchor, setup: function () {
                    ...
                    type: "vbox", width: "100%", align: "center", padding: 2, id: "popupFeatures", children: [{
                        type: "fieldset", label: b.popupFeatures, children: [{
                            ...
                            children: [{
                                ...
                                type: "checkbox", id: "status", label: b.popupStatusBar,
                                setup: f, commit: k
                            }]
                        }, {
                            type: "hbox",
                            children: [{
                                ...
                                setup: f,
                                commit: k
                            }, {type: "checkbox", id: "toolbar", label: b.popupToolbar, setup: f, commit: k}]
                        }, {
                            type: "hbox",
                            children: [{
                                type: "checkbox",
                                ...
                                setup: f,
                                commit: k
                            }, {type: "checkbox", id: "fullscreen", label: b.popupFullScreen, setup: f, commit: k}]
                        }, {
                            type: "hbox",
                            children: [{
                                type: "checkbox",
                                ...
                                type: "checkbox", id: "dependent", label: b.popupDependent,
                                setup: f, commit: k
                            }]
                        }, {
                            type: "hbox",
                ...
                if (this._.selectedElement) {
                    ...
                    if (d == f || "email" == a.type && -1 != f.indexOf("@"))e.setHtml("email" == a.type ? a.email.address : c.set["data-cke-saved-href"]), b.selectElement(e);
