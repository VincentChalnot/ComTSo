...
return function(g,e){var a=g.uiColor,a={id:"."+g.id,defaultBorder:b(a,-0.1),defaultGradient:c(b(a,0.9),a),lightGradient:c(b(a,1),b(a,0.7)),mediumGradient:c(b(a,0.8),b(a,0.5)),ckeButtonOn:c(b(a,0.6),b(a,0.7)),ckeResizer:b(a,-0.4),ckeToolbarSeparator:b(a,0.5),ckeColorauto:b(a,0.8),dialogBody:b(a,0.7),dialogTabSelected:c("#FFFFFF","#FFFFFF"),dialogTabSelectedBorder:"#FFF",elementsPathColor:b(a,-0.6),elementsPathBg:a,menubuttonIcon:b(a,0.5),menubuttonIconHover:b(a,0.3)};return f[e].output(a).replace(/\[/g,
    ...
    (function () {
        function h(a) {
            function m() {
                d = a.document;
                n = d[CKEDITOR.env.ie ? "getBody" : "getDocumentElement"]();
                c = CKEDITOR.env.quirks ? d.getBody() : d.getDocumentElement();
                e = CKEDITOR.dom.element.createFromHtml('\x3cspan style\x3d"margin:0;padding:0;border:0;clear:both;width:1px;height:1px;display:block;"\x3e' + (CKEDITOR.env.webkit ? "\x26nbsp;" : "") + "\x3c/span\x3e", d)
            }

            function f() {
                k && c.setStyle("overflow-y", "hidden");
                var g = a.window.getViewPaneSize().height, b;
                n.append(e);
            ...
            var l, d, n, c, e, h = a.config.autoGrow_bottomSpace || 0, r = void 0 !== a.config.autoGrow_minHeight ? a.config.autoGrow_minHeight : 200, p = a.config.autoGrow_maxHeight || Infinity, k = !a.config.autoGrow_maxHeight;
            a.addCommand("autogrow", {
                exec: f,
                modes: {wysiwyg: 1}, readOnly: 1, canUndo: !1, editorFocus: !1
            });
            var t = {contentDom: 1, key: 1, selectionChange: 1, insertElement: 1, mode: 1}, q;
            for (q in t)a.on(q, function (g) {
                "wysiwyg" == g.editor.mode && setTimeout(function () {
                    var b = a.getCommand("maximize");
                    !a.window || b && b.state == CKEDITOR.TRISTATE_ON ? l = null : (f(), k || f())
                }, 100)
            });
            a.on("afterCommandExec", function (a) {
                "maximize" == a.data.name && "wysiwyg" == a.editor.mode && (a.data.command.state == CKEDITOR.TRISTATE_ON ? c.removeStyle("overflow-y") : f())
            });
            a.on("contentDom", m);
            m();
    ...
    CKEDITOR.plugins.add("imageresize", {
        init: function (a) {
            ...
            if (this.support() && b) {
                ...
                console.log(d + "x" + c);
                var e = new Image;
                e.ckeditorimageresize = {n: b, w: d, h: c};
                e.onerror = function () {
        ...
        }, supportResult: null, support: function () {
...
a.addFeature(b);CKEDITOR.dialog.add("bulletedListStyle",this.path+"dialogs/liststyle.js");a.addMenuGroup("list",108);a.addMenuItems({numberedlist:{label:a.lang.liststyle.numberedTitle,group:"list",command:"numberedListStyle"},bulletedlist:{label:a.lang.liststyle.bulletedTitle,group:"list",command:"bulletedListStyle"}});a.contextMenu.addListener(function(a){if(!a||a.isReadOnly())return null;for(;a;){var b=a.getName();if("ol"==b)return{numberedlist:CKEDITOR.TRISTATE_OFF};if("ul"==b)return{bulletedlist:CKEDITOR.TRISTATE_OFF};
    ...
    (function () {
        CKEDITOR.plugins.add("youtube", {
            ...
            init: function (a) {
                a.addCommand("youtube", new CKEDITOR.dialogCommand("youtube", {allowedContent: "div{*}; iframe{*}[!width,!height,!src,!frameborder,!allowfullscreen]; object param[*]"}));
                ...
                CKEDITOR.dialog.add("youtube", function () {
                    ...
                    return {
                        ...
                        minWidth: 500, minHeight: 200, contents: [{
                            id: "youtubePlugin",
                            expand: !0,
                            elements: [{
                                id: "txtEmbed",
                                ...
                                type: "html", html: a.lang.youtube.or +
                                "<hr>"
                            }, {
                                type: "hbox",
                                widths: ["70%", "15%", "15%"],
                                children: [{
                                    ...
                                    "default": null !=
                                    a.config.youtube_width ? a.config.youtube_width : "640",
                                    validate: function () {
                                        if (this.getValue()) {
                                    ...
                                    validate: function () {
                                        ...
                                        } else return alert(a.lang.youtube.noHeight),
                                            !1
                                    }
                                }]
                            }, {
                            ...
                            },
                                {
                                    ...
                                    type: "hbox", widths: ["55%", "45%"], children: [{
                                        id: "txtStartAt",
                                        type: "text",
                                        label: a.lang.youtube.txtStartAt,
                                        validate: function () {
                                            if (this.getValue() && !/^(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)$/i.test(this.getValue()))return alert(a.lang.youtube.invalidTime),
                                                !1
                                        }
                                    }, {id: "empty", type: "html", html: ""}]
                                }]
                        }], onOk: function () {
                            var a = "", e = "";
                            if (this.getContentElement("youtubePlugin", "txtEmbed").isEnabled())a = this.getValueOf("youtubePlugin", "txtEmbed"); else {
                                var b = "//", d = [], f, h = this.getValueOf("youtubePlugin", "txtWidth"), i = this.getValueOf("youtubePlugin", "txtHeight"), b = !0 === this.getContentElement("youtubePlugin", "chkPrivacy").getValue() ? b + "www.youtube-nocookie.com/" : b + "www.youtube.com/", b = b + ("embed/" + c);
                                !1 === this.getContentElement("youtubePlugin", "chkRelated").getValue() &&
                                d.push("rel=0");
                                ...
                                !0 === this.getContentElement("youtubePlugin", "chkOlderCode").getValue() ? (b = b.replace("embed/", "v/"), b = b.replace(/&/g, "&amp;"), b = -1 === b.indexOf("?") ? b + "?" : b + "&amp;", b += "hl=" + (this.getParentEditor().config.language ? this.getParentEditor().config.language : "en") + "&amp;version=3", a = a + ('<object width="' + h + '" height="' + i + '" ' + e + ">") + ('<param name="movie" value="' + b + '"></param>') + '<param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param>' + ('<embed src="' + b + '" type="application/x-shockwave-flash" ') +
                                    ('width="' + h + '" height="' + i + '" ' + e + ' allowscriptaccess="always" ') + 'allowfullscreen="true"></embed></object>') : a = a + ('<iframe width="' + h + '" height="' + i + '" src="' + b + '" ' + e) + 'frameborder="0" allowfullscreen></iframe>';
    ...
    function hmsToSeconds(a) {
        for (var a = a.split(":"), c = 0, g = 1; 0 < a.length;)c += g * parseInt(a.pop(), 10), g *= 60;
        return c
    };
    CKEDITOR.plugins.add("notification", {
        requires: "toolbar", init: function (b) {
            function a(b) {
                var a = new CKEDITOR.dom.element("div");
    ...
    Notification.prototype = {
        show: function () {
            ...
            var c = this.element, d = c.findOne(".cke_notification_message"), e = c.findOne(".cke_notification_progress"), g = b.type;
    ...
    Area.prototype = {
        add: function (b) {
            ...
            var a = this.element, c = this.editor, d = c.ui.contentsElement.getClientRect(), e = c.ui.contentsElement.getDocumentPosition(), c = c.ui.space("top"), g = c.getClientRect(), m = a.getClientRect(), l, f = this._notificationWidth,
                h = this._notificationMargin;
            l = CKEDITOR.document.getWindow();
            var p = l.getScrollPosition(), q = l.getViewPaneSize(), r = CKEDITOR.document.getBody(), t = r.getDocumentPosition(), k = CKEDITOR.tools.cssLength;
            ...
            c.isVisible() && g.bottom > d.top && g.bottom < d.bottom - m.height ? a.setStyles({
                position: "fixed",
                top: k(g.bottom)
            }) :
                0 < d.top ? a.setStyles({
                    position: "absolute",
                    top: k(e.y)
                }) : e.y + d.height - m.height > p.y ? a.setStyles({
                    position: "fixed",
                    top: 0
                }) : a.setStyles({position: "absolute", top: k(e.y + d.height - m.height)});
    ...
    (function () {
        function k(a) {
            var b = null != a.config.autosave_SaveKey ? a.config.autosave_SaveKey : "autosave_" + window.location + "_" + a.id, g = null != a.config.autosave_NotOlderThen ? a.config.autosave_NotOlderThen : 1440, c = null != a.config.autosave_saveOnDestroy ? a.config.autosave_saveOnDestroy : !1, d = null != a.config.autosave_saveDetectionSelectors ? a.config.autosave_saveDetectionSelectors : "a[href^\x3d'javascript:__doPostBack'][id*\x3d'Save'],a[id*\x3d'Cancel']";
            CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave") +
                "js/extensions.min.js"), function () {
                p(a, b);
                if (localStorage.getItem(b)) {
                    var c = h(b), d = c.data, c = c.saveTime;
                    a.getSnapshot() == d ? localStorage.removeItem(b) : moment(new Date).diff(new Date(c), "minutes") > g ? e(b) : (d = a.lang.autosave.loadSavedContent.replace("{0}", moment(c).locale(a.config.language).format(a.lang.autosave.dateFormat)), confirm(d) ? a.openDialog("autosaveDialog") : e(b))
                }
            });
        ...
        function m(a, b) {
            var c = LZString.compressToUTF16(JSON.stringify({
                data: b.getSnapshot(),
                saveTime: new Date
            }));
            localStorage.setItem(a, c);
            (new CKEDITOR.plugins.notification(b, {message: b.lang.autosave.autoSaveMessage, type: "success"})).show()
        }
        ...
        function n(a, b, c) {
            c = h(c);
            var e = difflib.stringAsLines(b.getSnapshot()), d = difflib.stringAsLines(c.data), f = (new difflib.SequenceMatcher(e, d)).get_opcodes();
        ...
        if (function () {
            ...
            CKEDITOR.plugins.add("autosave", {
                requires: "notification", version: .13,
                init: function (a) {
            ...
            var c = 0, f = !1, l = function (a) {
                c || (c = setTimeout(q, 1E3 * (null !=
                    CKEDITOR.config.autosave_delay ? CKEDITOR.config.autosave_delay : 10), a))
            }, q = function (a) {
                if (f)l(a); else if (a.editor.checkDirty() || a.editor.plugins.bbcode)f = !0, a = a.editor, m(null != a.config.autosave_SaveKey ? a.config.autosave_SaveKey : "autosave_" + window.location + "_" + a.id, a), c = 0, f = !1
            }
        } else CKEDITOR.plugins.add("autosave", {})
    })();
    CKEDITOR.config.plugins = 'autogrow,basicstyles,blockquote,dialogui,dialog,clipboard,enterkey,entities,popup,filebrowser,floatingspace,panel,floatpanel,listblock,button,richcombo,format,horizontalrule,image,imagebrowser,imageresize,indent,indentblock,indentlist,justify,fakeobjects,link,list,menu,contextmenu,liststyle,maximize,removeformat,specialchar,toolbar,undo,wysiwygarea,youtube,notification,autosave';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,image,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,justifyblock,456,,justifycenter,480,,justifyleft,504,,justifyright,528,,anchor-rtl,552,,anchor,576,,link,600,,unlink,624,,bulletedlist-rtl,648,,bulletedlist,672,,numberedlist-rtl,696,,numberedlist,720,,maximize,744,,removeformat,768,,specialchar,792,,redo-rtl,816,,redo,840,,undo-rtl,864,,undo,888,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,image,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,justifyblock,456,auto,justifycenter,480,auto,justifyleft,504,auto,justifyright,528,auto,anchor-rtl,552,auto,anchor,576,auto,link,600,auto,unlink,624,auto,bulletedlist-rtl,648,auto,bulletedlist,672,auto,numberedlist-rtl,696,auto,numberedlist,720,auto,maximize,744,auto,removeformat,768,auto,specialchar,792,auto,redo-rtl,816,auto,redo,840,auto,undo-rtl,864,auto,undo,888,auto', 'icons.png');
    })();
